 	...
 	<div class="modal-dialog modal-lg">
 		<div class="modal-content">
 			...
 			<div class="modal-body">
 				<form method="post" action="<?= base_url('admin/kusioner/tambahP') ?>">
 					<div class="row">
 						<div class="col-sm-12">
 							<div class="form-group">
 								<div class="form-group">
 									<label>Judul Kusioner</label>
 									<select class="form-control select2" name="judul" style="width: 100%;">
 										<?php $judul = $this->db->get('tbl_kuisioner')->result_array(); ?>
 										<?php foreach ($judul as $j) : ?>
 											<option value="<?= $j['id_kuisioner'] ?>"><?= $j['judul']; ?></option>
 										<?php endforeach; ?>
 									</select>
 								</div>
 							</div>
 							<div class="form-group">
 								<label for="exampleInputBorder">Pertanyaan<code></code></label>
 								<input type="text" class="form-control " id="pertanyaan" name="pertanyaan" placeholder="Pertanyaan kusioner..">
 							</div>
 						</div>
 	...
 	<div class="modal fade" id="modal-lihat-<?= $us['id_kuisioner']; ?>">
 		<div class="modal-dialog modal-lg">
 			<div class="modal-content">
 				...
 				<div class="modal-body">
 					<h4 aria-readonly=""><?= $us['id_kuisioner']; ?></h4>
 					<h4><?= $us['judul'] ?></h4>
 					<h4><?= $us['pertanyaan'] ?></h4>
 				</div>
 			</div>
